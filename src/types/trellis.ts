...
export type TrellisReviewJudgment = "ready_to_archive" | "needs_verification" | "in_progress" | "planning" | "insufficient_evidence";
...
export interface TrellisProgress {
  ...
  artifacts: { prd: number; design: number; implement: number };
...
export interface TrellisAvailability {
  supported: boolean;
  detected: boolean;
  reason?: "remote_not_supported" | "not_trellis" | "desktop_only";
}
